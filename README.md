...
# Public variables
The code starts with assigning the name and abbreviation of the token using a string variable. The  name is token name is  'rahees' and abbreviation as 'rahi'
# Mapping variable
...
contract MyToken {
    ...
    string public tokenName = "rahees";
    string public tokenAbbrv = "rahi";
